...
function CreateNewPlaceV2() {
  ...
  let fields = formFieldsHandler(currentCalendarData?.forms, entitiesClass.place);
  let formFields = currentCalendarData?.forms?.filter((form) => form?.formName === entitiesClass.place);
...
export default CreateNewPlaceV2;
