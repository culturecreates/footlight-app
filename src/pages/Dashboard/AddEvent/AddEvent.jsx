                      ...
                      ({ getFieldValue }) => ({
                        validator() {
                          if (
                            ...
                            return Promise.reject(new Error(t('dashboard.events.addEditEvent.validations.location')));
                        },
                      }),
                    ]}>
                    <Form.Item
                  ...
                  <>
                      ...
                      <Form.Item name="organizers" initialValue={selectedOrganizers}>
                        <Popover
                          ...
                          <EventsSearch
                            ...
                            placeholder={t(
                              'dashboard.events.addEditEvent.otherInformation.organizer.searchPlaceholder',
                            )}
                            onChange={(e) => {
                    ...
                    <Form.Item
                      ...
                      <Form.Item
                        ...
                        <StyledInput
                          placeholder={t(
                            'dashboard.events.addEditEvent.otherInformation.contact.placeHolderPhoneNumber',
                          )}
                        />
                      </Form.Item>
                      <Form.Item
                      ...
                      <Form.Item name="performers" initialValue={selectedPerformers}>
                        <Popover
                          ...
                          <EventsSearch
                            style={{ borderRadius: '4px' }}
                            placeholder={t(
                              'dashboard.events.addEditEvent.otherInformation.performer.searchPlaceholder',
                            )}
                            onChange={(e) => {
                      ...
                      <Form.Item name="supporters" initialValue={selectedSupporters}>
                        <Popover
                          ...
                          <EventsSearch
                            style={{ borderRadius: '4px' }}
                            placeholder={t(
                              'dashboard.events.addEditEvent.otherInformation.supporter.searchPlaceholder',
                            )}
                            onChange={(e) => {
                  ...
                  <>
                    <Form.Item
                      ...
                      <TreeSelectOption
                        ...
                        placeholder={t(
                          'dashboard.events.addEditEvent.eventAccessibility.placeHolderEventAccessibility',
                        )}
                        tagRender={(props) => {
                          const { label, closable, onClose } = props;
                          return (
